...
expression_matrix_table <- data.frame(
  ...
  Metrics = c(rep(c("Raw counts", "TPM", "FPKM", "Raw counts", "TPM"), 2)),
...
#write.table(mastertable, file = "/Volumes/projects/RelapseALL/common/JeffKlco_47AMLBulk/DRpars/Quantification/mastertable.txt", col.names = T, row.names = F, sep = "\t", quote = F)
#mastertable <- read.table("/Volumes/projects/RelapseALL/common/JeffKlco_47AMLBulk/DRpars/Quantification/mastertable.txt", header = T, sep = "\t", quote = "", stringsAsFactors = F)
#mastertable <- read.table("/research_jude/rgs01_jude/groups/yu3grp/projects/RelapseALL/common/JeffKlco_47AMLBulk/DRpars/Quantification/mastertable.txt", header = T, sep = "\t", quote = "", stringsAsFactors = F)
...
<div class = "col-md-4">
```{r echo = F}
#curveStats <- read.table("/Volumes/projects/RelapseALL/common/JeffKlco_47AMLBulk/DRpars/Quantification/05_genebodyCoverage.curveStats.txt", header = T, sep = "\t", quote = "", stringsAsFactors = F)
#curveStats <- read.table("/research_jude/rgs01_jude/groups/yu3grp/projects/RelapseALL/common/JeffKlco_47AMLBulk/DRpars/Quantification/05_genebodyCoverage.curveStats.txt", header = T, sep = "\t", quote = "", stringsAsFactors = F)
